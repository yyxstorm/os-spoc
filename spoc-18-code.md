...
do_exit(int error_code) {
    ...
    cprintf("[Call schedule() in do_exit]\n");
    schedule();
...
repeat:
    ...
    if (haskid) {
        ...
        cprintf("[Call schedule() in do_wait]\n");
        schedule();
...
init_main(void *arg) {
    ...
    cprintf("[Call schedule() in do_main]\n");
        schedule();
    }
...
cpu_idle(void) {
    ...
    cprintf("[Call schedule() in cpu_idle]\n");
            schedule();
        }
    }
}
